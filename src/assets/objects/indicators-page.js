...
export const IndicatorDataEn = [
  ...
  },
  {
    ...
    dotb_1: "Delta Histogram: Get information about buying pressure in the selected area, allowing you to detect exhaustion or continuity in movements.",
    dotb_2: "Threshold Detection: Through statistical calculations, visualize the most relevant volumes to improve your entry timing.",
    dotb_3: "Statistics: Access average data, standard deviation, and expected maximum value of Volume, Delta, and Range in a clear interface. These insights will help you filter entries and make more informed decisions.",
...
export const IndicatorDataEs = [
  {       
    ...
    subb_1:
      "Transforma tu Experiencia Visual en el Análisis de OrderFlow",
