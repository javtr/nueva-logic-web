...
export const ArticlesDataEs = [
  {
    ...
    sepB_1: "",
      ...
      titk_5: ["Contratos de Futuros: Explorando los Más Negociados por Volumen", "contratos"],
      ...
      dotb_20:"Movimientos de Precios: El objetivo principal es capitalizar las fluctuaciones en los precios de los activos subyacentes. Los traders de futuros buscan identificar tendencias y patrones que les permitan tomar decisiones informadas.",
      
      dotb_22:"Flexibilidad Temporal: A diferencia de aquellos que operan con la intención de ejecutar contratos en la fecha de vencimiento, los especuladores en futuros no están limitados por plazos específicos. Pueden entrar y salir de posiciones según las oportunidades del mercado.",

      dotb_24:"Diversidad de Activos: Los traders especulativos pueden participar en una amplia variedad de mercados, desde divisas hasta materias primas y desde índices bursátiles hasta tasas de interés. Esta diversificación les brinda la capacidad de adaptarse a diferentes condiciones del mercado.",

      dotb_26:"Gestión de Riesgos: Aunque la especulación puede implicar cierto nivel de riesgo, los traders de futuros aplican estrategias de gestión de riesgos para proteger sus inversiones. Esto puede incluir la utilización de órdenes de stop-loss y técnicas de diversificación.",


      tit3_24:"Beneficios del Trading de Futuros como Especulación:",


      dotb_28:"Potencial de Ganancias: Los movimientos de precios significativos pueden resultar en ganancias sustanciales para los especuladores hábiles.",

      dotb_30:"Diversificación: La diversidad de activos subyacentes permite a los traders especulativos explorar oportunidades en diferentes sectores y clases de activos.",

      dotb_32:"Acceso a Mercados Internacionales: El trading de futuros facilita la participación en mercados globales, permitiendo a los especuladores capitalizar eventos económicos y políticos a nivel mundial.",
      ...
      lnkb3: ["/#indicators", "Potencia tu Estrategia: Accede a Nuestros Indicadores"],
  ...
  },
  {
    ...
    txtb_1:
      ...
      txtb_10:"NinjaTrader se destaca como una plataforma integral con asociaciones clave con brokers populares como Interactive Brokers y TD Ameritrade. Algunas de sus características principales incluyen:",

      dotb_10:"Trading de Futuros Micro E-mini: Contratos más pequeños para S&P 500, Dow Jones, NASDAQ-100 y Russell 2000.",

      dotb_12:"Micro Petróleo Crudo (MCL): Oportunidad de operar en los mercados de energía a una fracción del precio del contrato estándar.",

      dotb_14:"Nano Bitcoin: Futuros de Bitcoin en una centésima parte del precio, ideal para especuladores de criptomonedas.",

      dotb_16:"Conexión con Brokers Reconocidos: Integración con brokers como Interactive Brokers y TD Ameritrade para operar una amplia gama de activos.",
      ...
      txtb_36: "Personaliza tu experiencia de trading preconfigurando teclas de acceso rápido. Esto te permitirá ejecutar órdenes con rapidez, capitalizando incluso los pequeños movimientos del mercado. Descubre cómo agilizar tu proceso de trading para aprovechar al máximo cada oportunidad.",


      tit3_38:"Adaptabilidad a tu Estilo de Trading:",

      txtb_38: "Los gráficos en NinjaTrader admiten una amplia variedad de indicadores técnicos, tanto populares como personalizados. Ajusta los gráficos según tu estilo de trading, incorporando las herramientas que mejor se adapten a tus necesidades y estrategias.",


      tit3_40:"Visualización Clara del Estado de Operación:",

      txtb_40: "En NinjaTrader, el estado de tus operaciones se presenta de manera transparente en los gráficos. Las ganancias o pérdidas se muestran directamente junto con el estado de ejecución, brindándote una comprensión inmediata de tus posiciones.",

      txtb_41: "Explora esta sección detallada para aprovechar al máximo las herramientas de gráficos y flujo de órdenes en NinjaTrader. Desde la operación eficiente hasta la personalización completa, descubre cómo esta plataforma eleva tu experiencia de trading a nuevos niveles.",


      titk_5: ["Descubre sin Riesgos: Cuentas Demo en NinjaTrader", "demo"],

      txtb_50: "Ingresar al mundo del trading puede ser desafiante, pero NinjaTrader facilita el proceso al ofrecer cuentas demo que permiten a los traders explorar y perfeccionar sus habilidades antes de arriesgar su capital. En esta sección, exploraremos cómo las cuentas demo de NinjaTrader brindan a los usuarios una valiosa oportunidad de desarrollo y familiarización con la plataforma.",


      tit3_52:"Simulación y Backtesting:",

      txtb_52: "Incluso sin una cuenta financiada, NinjaTrader proporciona herramientas de simulación y backtesting de vanguardia. Estas funciones permiten a los traders desarrollar estrategias, ajustar sus enfoques y explorar la plataforma sin la presión de operar con dinero real. La simulación ofrece un entorno de práctica realista, replicando las condiciones del mercado.",


      tit3_54:"Desarrolla tu Estrategia:",

      txtb_54: "Las cuentas demo en NinjaTrader son un terreno de juego seguro para desarrollar y perfeccionar estrategias de trading. Los traders pueden experimentar con diferentes enfoques, probar teorías y ajustar sus tácticas según sea necesario, todo sin arriesgar fondos reales.",


      tit3_56:"Familiarízate con NinjaTrader:",

      txtb_56: "Antes de sumergirte en el trading en vivo, las cuentas demo te permiten familiarizarte con la plataforma NinjaTrader. Explora las herramientas, ajusta la configuración y comprende la interfaz, todo ello sin la preocupación de posibles pérdidas financieras.",


      tit3_58:"Prueba de Rendimiento con Backtesting:",

      txtb_58: "La función de backtesting en NinjaTrader te permite evaluar el rendimiento histórico de tu estrategia en condiciones de mercado anteriores. Esta herramienta es esencial para comprender cómo podría haber funcionado tu estrategia en el pasado y ajustarla para el futuro.",
  ...
  },
  {
    ...
    subb_1:
      ...
      titk_3: ["Claves para Entender los Fundamentos del Trading según Wyckoff:", "claves"],
      ...
      titk_5: ["Aplicación del Método Wyckoff en Inversiones Diarias", "aplicaciones"],
...
export const ArticlesDataEn = [
  {
    ...
    titk_5: ["Futures Contracts: Exploring the Most Traded by Volume", "contracts"],
  ...
  },
  {
    ...
    txtb_10: "NinjaTrader stands out as a comprehensive platform with key partnerships with popular brokers like Interactive Brokers and TD Ameritrade. Some of its key features include:",

    dotb_10: "Micro E-mini Futures Trading: Smaller contracts for S&P 500, Dow Jones, NASDAQ-100, and Russell 2000.",

    dotb_12: "Micro Crude Oil (MCL): Opportunity to trade in energy markets at a fraction of the standard contract price.",

    dotb_14: "Nano Bitcoin: Bitcoin futures at one-hundredth of the price, ideal for cryptocurrency speculators.",

    dotb_16: "Integration with Recognized Brokers: Integration with brokers like Interactive Brokers and TD Ameritrade to trade a wide range of assets.",
    ...
    txtb_36: "Customize your trading experience by preconfiguring quick access keys. This will allow you to execute orders quickly, capitalizing on even small market movements. Learn how to streamline your trading process to make the most of every opportunity.",

    tit3_38: "Adaptability to Your Trading Style:",

    txtb_38: "Charts in NinjaTrader support a wide variety of technical indicators, both popular and custom. Adjust the charts according to your trading style, incorporating tools that best suit your needs and strategies.",

    tit3_40: "Clear Visualization of Trade Status:",

    txtb_40: "In NinjaTrader, the status of your trades is presented transparently on the charts. Profits or losses are displayed directly along with the execution status, giving you an immediate understanding of your positions.",

    txtb_41: "Explore this detailed section to make the most of charting and order flow tools in NinjaTrader. From efficient trading to complete customization, discover how this platform elevates your trading experience to new levels.",

    titk_5: ["Risk-Free Exploration: Demo Accounts in NinjaTrader", "demo"],

    txtb_50: "Entering the world of trading can be challenging, but NinjaTrader simplifies the process by offering demo accounts that allow traders to explore and hone their skills before risking their capital. In this section, we will explore how NinjaTrader demo accounts provide users with a valuable opportunity for development and familiarization with the platform.",
    ...
    txtb_54: "Demo accounts in NinjaTrader are a safe playground to develop and refine trading strategies. Traders can experiment with different approaches, test theories, and adjust tactics as needed, all without risking real funds.",

    tit3_56: "Familiarize Yourself with NinjaTrader:",

    txtb_56: "Before diving into live trading, demo accounts allow you to familiarize yourself with the NinjaTrader platform. Explore the tools, adjust settings, and understand the interface, all without the concern of potential financial losses.",

    tit3_58: "Performance Testing with Backtesting:",

    txtb_58: "The backtesting feature in NinjaTrader allows you to evaluate the historical performance of your strategy in previous market conditions. This tool is essential for understanding how your strategy might have performed in the past and adjusting it for the future.",
  },
  {
    ...
    titk_5: ["Difference Between Mini Futures and Other Futures:", "differences"],
  ...
  },
  {
    ...
    titk_5: ["Application of the Wyckoff Method in Daily Investments", "applications"],
